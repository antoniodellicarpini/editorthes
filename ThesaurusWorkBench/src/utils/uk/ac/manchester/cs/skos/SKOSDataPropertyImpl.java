 ...
 */
public class SKOSDataPropertyImpl implements SKOSDataProperty {

    OWLDataProperty property;

    public SKOSDataPropertyImpl (OWLDataFactory factory, URI uri) {
        this.property = factory.getOWLDataProperty(IRI.create(uri));
    }

    public SKOSDataPropertyImpl (OWLDataProperty property) {
    ...
    public OWLDataProperty getDataObjectProperty() {
        return property;
    }
